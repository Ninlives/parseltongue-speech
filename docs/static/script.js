...
contains:b}}}());hljs.registerLanguage("shell",function(){"use strict";return function(s){return{
name:"Shell Session",aliases:["console"],contains:[{className:"meta",
begin:"^\\s{0,3}[/\\w\\d\\[\\]()@-]*[>%$#]",starts:{end:"$",subLanguage:"bash"}
...
aliases:["nixos"],keywords:n,contains:s}}}());hljs.initHighlightingOnLoad();/*!
 * pangu.js
 * --------
 * @version: 4.0.7
